...
/// 0xFFFFFFFF is the size can not be calculated
...
long    get_inf_attr(long offset);
success set_inf_attr(long offset, long value);

// Set or clear bits in parameter
//      offset - same as for get_inf_attr()/set_inf_attr() functions
//      bits   - bit mask
//      on     - boolean value, set or clear bits
// Convenience function
void set_flag(long offset, long bits, long on);

#endif
// 'offset' may be one of the following:

#define INF_VERSION     4               // short;   Version of database
#define INF_PROCNAME    6               // char[16];Name of current processor
#define INF_GENFLAGS    22              // ushort;  General flags:
...
#define         INFFL_CHKOPS     0x20   //              check manual operands?
#define         INFFL_NMOPS      0x40   //              allow non-matched operands?
#define         INFFL_GRAPH_VIEW 0x80   //              currently using graph options (\dto{graph})
#define INF_LFLAGS      24              // uint32   IDP-dependent flags
...
#define INF_CHANGE_COUNTER 28           // uint32; database change counter; keeps track of byte and segment modifications

#define INF_FILETYPE    32              // short;   type of input file (see ida.hpp)
...
#define INF_OSTYPE      34              // short;   FLIRT: OS type the program is for
#define         OSTYPE_MSDOS 0x0001
#define         OSTYPE_WIN   0x0002
#define         OSTYPE_OS2   0x0004
#define         OSTYPE_NETW  0x0008
#define INF_APPTYPE     36              // short;   FLIRT: Application type
...
#define INF_ASMTYPE     38              // char;    target assembler number (0..n)
#define INF_SPECSEGS    39              // uchar;   What format do special segments use? 0-unspecified, 4-entries are 4 bytes, 8- entries are 8 bytes
                                        //          program execution

#define INF_AF          40              // uint32;  Analysis flags:
...
#define INF_AF2         44              // uint32;  Analysis flags 2

#define AF2_DOEH        0x00000001      //              Handle EH information

#define INF_BASEADDR    48              // uval_t;  base paragraph of the program
#define INF_START_SS    52              // int32;   value of SS at the start
#define INF_START_CS    56              // int32;   value of CS at the start
#define INF_START_IP    60              // ea_t;    IP register value at the start of
#define INF_START_EA    64              // ea_t;    Linear address of program entry point
#define INF_START_SP    68              // ea_t;    SP register value at the start of
#define INF_MAIN        72              // ea_t;    address of main()
#define INF_MIN_EA      76              // ea_t;    The lowest address used
                                        //          in the program
#define INF_MAX_EA      80              // ea_t;    The highest address used
                                        //          in the program - 1
#define INF_OMIN_EA     84
#define INF_OMAX_EA     88
#define INF_LOW_OFF     92              // ea_t;    low limit of voids
#define INF_HIGH_OFF    96              // ea_t;    high limit of voids
#define INF_MAXREF     100              // uval_t;  max xref depth
#define INF_START_PRIVRANGE      104    // uval_t; Range of addresses reserved for internal use.
#define INF_END_PRIVRANGE        108    // uval_t; Initially (MAXADDR, MAXADDR+0x100000)

#define INF_NETDELTA             112    // sval_t; Delta value to be added to all adresses for mapping to netnodes.
                                        // Initially 0.
// CROSS REFERENCES
#define INF_XREFNUM    116              // char;    Number of references to generate
                                        //          0 - xrefs won't be generated at all
#define INF_TYPE_XREFS 117              // char;    Number of references to generate
                                        //          in the struct & enum windows
                                        //          0 - xrefs won't be generated at all
#define INF_REFCMTS    118              // uchar; number of comment lines to
                                        //        generate for refs to ASCII
                                        //        string or demangled name
                                        //        0 - such comments won't be
                                        //        generated at all
#define INF_XREFS      119              // char;    xrefs representation:
...
// NAMES
#define INF_MAX_AUTONAME_LEN 120        // ushort;  max autogenerated name length (without zero byte)
#define INF_NAMETYPE   122              // char;    dummy names represenation type
#define         NM_REL_OFF      0
#define         NM_PTR_OFF      1
#define         NM_NAM_OFF      2
#define         NM_REL_EA       3
...
#define         NM_SHORT        9
#define         NM_SERIAL      10
#define INF_SHORT_DN    124             // int32;   short form of demangled names
#define INF_LONG_DN     128             // int32;   long form of demangled names
                                        //          see demangle.h for definitions
#define INF_DEMNAMES   132              // char;    display demangled names as:
...
#define INF_LISTNAMES  133              // uchar;   What names should be included in the list?
...
#define INF_INDENT     134              // char;    Indention for instructions
#define INF_COMMENT    135              // char;    Indention for comments
#define INF_MARGIN     136              // ushort;  max length of data lines
#define INF_LENXREF    138              // ushort;  max length of line with xrefs
#define INF_OUTFLAGS   140              // uint32;  output flags
...
#define INF_CMTFLAG    144              // char;    comments:
...
#define INF_BORDER     145              // char;    Generate borders?
#define INF_BINPREF    146              // short;   # of instruction bytes to show
                                        //          in line prefix
#define INF_PREFFLAG   148              // char;    line prefix type:
...
// STRING LITERALS
#define INF_STRLIT_FLAGS 149            // uchar;   string literal flags
...
#define INF_STRLIT_BREAK  150           // char;    string literal line break symbol
#define INF_STRLIT_ZEROES 151           // char;    leading zeroes
#define INF_STRTYPE       152           // int32;   current ascii string type
...
#define INF_STRLIT_PREF   156           // char[16];ASCII names prefix
#define INF_STRLIT_SERNUM 172           // uval_t;  serial number

// DATA ITEMS
#define INF_DATATYPES     176           // uval_t;  data types allowed in data carousel

// COMPILER
#define INF_COMPILER    180             // uchar;   compiler
...
#define INF_MODEL       181             // uchar;  memory model & calling convention
#define INF_SIZEOF_INT  182             // uchar;  sizeof(int)
#define INF_SIZEOF_BOOL 183             // uchar;  sizeof(bool)
#define INF_SIZEOF_ENUM 184             // uchar;  sizeof(enum)
#define INF_SIZEOF_ALGN 185             // uchar;  default alignment
#define INF_SIZEOF_SHORT 186
#define INF_SIZEOF_LONG  187
#define INF_SIZEOF_LLONG 188
#define INF_SIZEOF_LDBL  189            // uchar;  sizeof(long double)
#define INF_ABIBITS      192            // uint32; ABI features
...
#define INF_APPCALL_OPTIONS 196         // uint32; appcall options

#ifdef __EA64__                 // redefine the offsets for 64-bit version
#define INF_VERSION                4
#define INF_PROCNAME               6
#define INF_GENFLAGS              22
#define INF_LFLAGS                24
#define INF_CHANGE_COUNTER        28
#define INF_FILETYPE              32
#define INF_OSTYPE                34
#define INF_APPTYPE               36
#define INF_ASMTYPE               38
#define INF_SPECSEGS              39
#define INF_AF                    40
#define INF_AF2                   44
#define INF_BASEADDR              48
#define INF_START_SS              56
#define INF_START_CS              64
#define INF_START_IP              72
#define INF_START_EA              80
#define INF_START_SP              88
#define INF_MAIN                  96
#define INF_MIN_EA               104
#define INF_MAX_EA               112
#define INF_OMIN_EA              120
#define INF_OMAX_EA              128
#define INF_LOW_OFF              136
#define INF_HIGH_OFF             144
#define INF_MAXREF               152
#define INF_START_PRIVRANGE      160
#define INF_END_PRIVRANGE        168
#define INF_NETDELTA             176
#define INF_XREFNUM              184
#define INF_TYPE_XREFS           185
#define INF_REFCMTS              186
#define INF_XREFS                187
#define INF_MAX_AUTONAME_LEN     188
#define INF_NAMETYPE             190
#define INF_SHORT_DN             192
#define INF_LONG_DN              196
#define INF_DEMNAMES             200
#define INF_LISTNAMES            201
#define INF_INDENT               202
#define INF_COMMENT              203
#define INF_MARGIN               204
#define INF_LENXREF              206
#define INF_OUTFLAGS             208
#define INF_CMTFLAG              212
#define INF_BORDER               213
#define INF_BINPREF              214
#define INF_PREFFLAG             216
#define INF_STRLIT_FLAGS         217
#define INF_STRLIT_BREAK         218
#define INF_STRLIT_ZEROES        219
#define INF_STRTYPE              220
#define INF_STRLIT_PREF          224
#define INF_STRLIT_SERNUM        240
#define INF_DATATYPES            248
#define INF_COMPILER             256
#define INF_MODEL                257
#define INF_SIZEOF_INT           258
#define INF_SIZEOF_BOOL          259
#define INF_SIZEOF_ENUM          260
#define INF_SIZEOF_ALGN          261
#define INF_SIZEOF_SHORT         262
#define INF_SIZEOF_LONG          263
#define INF_SIZEOF_LLONG         264
#define INF_SIZEOF_LDBL          265
#define INF_ABIBITS              268
#define INF_APPCALL_OPTIONS      272
#endif  // __EA64__
...
#define FUNCATTR_FRAME   12     // readonly: function frame id
#define FUNCATTR_FRSIZE  16     // readonly: size of local variables
#define FUNCATTR_FRREGS  20     // readonly: size of saved registers area
#define FUNCATTR_ARGSIZE 24     // readonly: number of bytes purged from the stack
#define FUNCATTR_FPD     28     // frame pointer delta
#define FUNCATTR_COLOR   32     // function color code
#define FUNCATTR_OWNER   12     // readonly: chunk owner (valid only for tail chunks)
#define FUNCATTR_REFQTY  16     // readonly: number of chunk parents (valid only for tail chunks)
#else // X64
#define FUNCATTR_START    0
#define FUNCATTR_END      4
#define FUNCATTR_FLAGS    8
#define FUNCATTR_FRAME   16
#define FUNCATTR_FRSIZE  20
#define FUNCATTR_FRREGS  24
#define FUNCATTR_ARGSIZE 28
#define FUNCATTR_FPD     32
#define FUNCATTR_COLOR   36
#define FUNCATTR_OWNER   16
#define FUNCATTR_REFQTY  20
#endif
#else // EA64
#ifndef __X64__
#define FUNCATTR_START    0
...
#define FUNCATTR_FRAME   20
#define FUNCATTR_FRSIZE  28
#define FUNCATTR_FRREGS  36
#define FUNCATTR_ARGSIZE 40
#define FUNCATTR_FPD     48
#define FUNCATTR_COLOR   56
#define FUNCATTR_OWNER   20
#define FUNCATTR_REFQTY  28
#else // X64
#define FUNCATTR_START    0
#define FUNCATTR_END      8
#define FUNCATTR_FLAGS   16
...
void set_fixup(long ea, long type, long targetsel, long targetoff, long displ);
...
#define Comments(x)             set_flag(INF_CMTFLAG, SW_ALLCMT, x)
...
#define SetType(ea, type) apply_type(ea, type, TINFO_DEFINITE)
...
#define Batch(batch)                     batch(batch)
...
#define AskIdent(defval, prompt)         ask_str(defval, HINT_IDENT, prompt)
...
#define ASCSTR_LEN2 STRTYPE_C_16
#define ASCSTR_LEN4 STRTYPE_C_32
