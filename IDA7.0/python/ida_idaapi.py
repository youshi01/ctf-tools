...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ida_idaapi', [dirname(__file__)])
        except ImportError:
            import _ida_idaapi
            return _ida_idaapi
        if fp is not None:
            try:
                _mod = imp.load_module('_ida_idaapi', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _ida_idaapi = swig_import_helper()
...
class loader_input_t(object):
    ...
    __repr__ = _swig_repr
    __idc_cvt_id__ = _swig_property(_ida_idaapi.loader_input_t___idc_cvt_id___get, _ida_idaapi.loader_input_t___idc_cvt_id___set)
    def __init__(self, *args):
        ...
        Closes the file
        """
        this = _ida_idaapi.new_loader_input_t(*args)
...
loader_input_t_swigregister = _ida_idaapi.loader_input_t_swigregister
