...
MY_CP_ACP = _ida_pro.MY_CP_ACP
MY_CP_OEM = _ida_pro.MY_CP_OEM
MY_CP_UTF8 = _ida_pro.MY_CP_UTF8

def get_utf8_char(*args):
  """
  get_utf8_char(pptr) -> wchar32_t
  """
  return _ida_pro.get_utf8_char(*args)
...
class uvalvec_t(object):
    ...
    def __init__(self, *args):
        ...
        """
        this = _ida_pro.new_uvalvec_t(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _ida_pro.delete_uvalvec_t
    __del__ = lambda self : None;
    def push_back(self, *args):
        ...
        """
        return _ida_pro.uvalvec_t_push_back(self, *args)

    def pop_back(self, *args):
        """
        pop_back(self)
        """
        return _ida_pro.uvalvec_t_pop_back(self, *args)

    def size(self, *args):
        """
        size(self) -> size_t
        """
        return _ida_pro.uvalvec_t_size(self, *args)

    def empty(self, *args):
        """
        empty(self) -> bool
        """
        return _ida_pro.uvalvec_t_empty(self, *args)

    def at(self, *args):
        """
        at(self, _idx) -> unsigned long long const &
        """
        return _ida_pro.uvalvec_t_at(self, *args)

    def qclear(self, *args):
        """
        qclear(self)
        """
        return _ida_pro.uvalvec_t_qclear(self, *args)

    def clear(self, *args):
        """
        clear(self)
        """
        return _ida_pro.uvalvec_t_clear(self, *args)
    ...
    def resize(self, *args):
        ...
        """
        return _ida_pro.uvalvec_t_resize(self, *args)

    def capacity(self, *args):
        """
        capacity(self) -> size_t
        """
        return _ida_pro.uvalvec_t_capacity(self, *args)

    def reserve(self, *args):
        """
        reserve(self, cnt)
        """
        return _ida_pro.uvalvec_t_reserve(self, *args)

    def truncate(self, *args):
        """
        truncate(self)
        """
        return _ida_pro.uvalvec_t_truncate(self, *args)

    def swap(self, *args):
        """
        swap(self, r)
        """
        return _ida_pro.uvalvec_t_swap(self, *args)

    def extract(self, *args):
        """
        extract(self) -> unsigned long long *
        """
        return _ida_pro.uvalvec_t_extract(self, *args)

    def inject(self, *args):
        """
        inject(self, s, len)
        """
        return _ida_pro.uvalvec_t_inject(self, *args)

    def __eq__(self, *args):
        """
        __eq__(self, r) -> bool
        """
        return _ida_pro.uvalvec_t___eq__(self, *args)

    def __ne__(self, *args):
        """
        __ne__(self, r) -> bool
        """
        return _ida_pro.uvalvec_t___ne__(self, *args)
    ...
    def begin(self, *args):
        ...
        """
        return _ida_pro.uvalvec_t_begin(self, *args)
    ...
    def end(self, *args):
        ...
        """
        return _ida_pro.uvalvec_t_end(self, *args)

    def insert(self, *args):
        """
        insert(self, it, x) -> qvector< unsigned long long >::iterator
        """
        return _ida_pro.uvalvec_t_insert(self, *args)
    ...
    def erase(self, *args):
        ...
        """
        return _ida_pro.uvalvec_t_erase(self, *args)
    ...
    def find(self, *args):
        ...
        """
        return _ida_pro.uvalvec_t_find(self, *args)

    def has(self, *args):
        """
        has(self, x) -> bool
        """
        return _ida_pro.uvalvec_t_has(self, *args)

    def add_unique(self, *args):
        """
        add_unique(self, x) -> bool
        """
        return _ida_pro.uvalvec_t_add_unique(self, *args)

    def _del(self, *args):
        """
        _del(self, x) -> bool
        """
        return _ida_pro.uvalvec_t__del(self, *args)

    def __len__(self, *args):
        """
        __len__(self) -> size_t
        """
        return _ida_pro.uvalvec_t___len__(self, *args)

    def __getitem__(self, *args):
        """
        __getitem__(self, i) -> unsigned long long const &
        """
        return _ida_pro.uvalvec_t___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(self, i, v)
        """
        return _ida_pro.uvalvec_t___setitem__(self, *args)

    front = ida_idaapi._qvector_front
    back = ida_idaapi._qvector_back
    __iter__ = ida_idaapi._bounded_getitem_iterator

uvalvec_t_swigregister = _ida_pro.uvalvec_t_swigregister
...
class intvec_t(object):
    ...
    def grow(self, *args):
        ...
        grow(self, x=int())
        """
        return _ida_pro.intvec_t_grow(self, *args)
...
class int64vec_t(object):
    ...
    def __init__(self, *args):
        ...
        """
        this = _ida_pro.new_int64vec_t(*args)
        try: self.this.append(this)
        except: self.this = this
    ...
    def pop_back(self, *args):
        ...
        pop_back(self)
        """
        return _ida_pro.int64vec_t_pop_back(self, *args)

    def size(self, *args):
        """
        size(self) -> size_t
        """
        return _ida_pro.int64vec_t_size(self, *args)

    def empty(self, *args):
        """
        empty(self) -> bool
        """
        return _ida_pro.int64vec_t_empty(self, *args)

    def at(self, *args):
        """
        at(self, _idx) -> long long const &
        """
        return _ida_pro.int64vec_t_at(self, *args)

    def qclear(self, *args):
        """
        qclear(self)
        """
        return _ida_pro.int64vec_t_qclear(self, *args)

    def clear(self, *args):
        """
        clear(self)
        """
        return _ida_pro.int64vec_t_clear(self, *args)
    ...
    def capacity(self, *args):
        ...
        capacity(self) -> size_t
        """
        return _ida_pro.int64vec_t_capacity(self, *args)

    def reserve(self, *args):
        """
        reserve(self, cnt)
        """
        return _ida_pro.int64vec_t_reserve(self, *args)

    def truncate(self, *args):
        """
        truncate(self)
        """
        return _ida_pro.int64vec_t_truncate(self, *args)

    def swap(self, *args):
        """
        swap(self, r)
        """
        return _ida_pro.int64vec_t_swap(self, *args)

    def extract(self, *args):
        """
        extract(self) -> long long *
        """
        return _ida_pro.int64vec_t_extract(self, *args)

    def inject(self, *args):
        """
        inject(self, s, len)
        """
        return _ida_pro.int64vec_t_inject(self, *args)

    def __eq__(self, *args):
        """
        __eq__(self, r) -> bool
        """
        return _ida_pro.int64vec_t___eq__(self, *args)

    def __ne__(self, *args):
        """
        __ne__(self, r) -> bool
        """
        return _ida_pro.int64vec_t___ne__(self, *args)
    ...
    def insert(self, *args):
        ...
        """
        return _ida_pro.int64vec_t_insert(self, *args)
    ...
    def has(self, *args):
        ...
        has(self, x) -> bool
        """
        return _ida_pro.int64vec_t_has(self, *args)

    def add_unique(self, *args):
        """
        add_unique(self, x) -> bool
        """
        return _ida_pro.int64vec_t_add_unique(self, *args)

    def _del(self, *args):
        """
        _del(self, x) -> bool
        """
        return _ida_pro.int64vec_t__del(self, *args)

    def __len__(self, *args):
        """
        __len__(self) -> size_t
        """
        return _ida_pro.int64vec_t___len__(self, *args)

    def __getitem__(self, *args):
        """
        __getitem__(self, i) -> long long const &
        """
        return _ida_pro.int64vec_t___getitem__(self, *args)

    def __setitem__(self, *args):
        """
        __setitem__(self, i, v)
        """
        return _ida_pro.int64vec_t___setitem__(self, *args)

    front = ida_idaapi._qvector_front
    back = ida_idaapi._qvector_back
    __iter__ = ida_idaapi._bounded_getitem_iterator

int64vec_t_swigregister = _ida_pro.int64vec_t_swigregister
int64vec_t_swigregister(int64vec_t)
